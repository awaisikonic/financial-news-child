...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},E={animation:!0,autohide:!0,delay:5e3};class x extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return E}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=x.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(x),e.defineJQueryPlugin(x),x}(r(),c(),w(),A())}(Qt);var Kt,Ut,Xt,Yt=Qt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Ut=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Ut||Xt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1);const Jt=document.querySelector(".menu-icon"),Gt=document.querySelector(".mobile-nav");Jt&&Jt.addEventListener("click",(()=>{Gt.classList.toggle("mobile-nav-active")}));const Zt=document.querySelector(".nav-menu-item-dropdwon"),en=document.querySelector(".desktop-dropdown");Zt.addEventListener("mouseover",(()=>{en.style.display="block"})),Zt.addEventListener("mouseout",(()=>{en.style.display="none"})),en.addEventListener("mouseover",(()=>{en.style.display="block"})),en.addEventListener("mouseout",(()=>{en.style.display="none"})),document.addEventListener("DOMContentLoaded",(function(){const e=document.querySelector(".mobile-nav-menu-item-dropdwon"),t=document.querySelector(".mobile-dropdown-menu"),n=e.querySelector("i");e.addEventListener("click",(function(e){e.preventDefault();const i="block"===t.style.display;t.style.display=i?"none":"block",n.classList.toggle("fa-chevron-down",i),n.classList.toggle("fa-chevron-up",!i)}));const i=document.querySelectorAll(".tab-btn"),s=document.querySelectorAll(".tab-content");s.forEach((e=>{e.style.display="none"})),s.forEach((e=>e.style.display="none")),i.forEach((e=>{const t=document.createElement("i");t.classList.add("fa-solid","fa-chevron-down"),e.appendChild(t),e.addEventListener("click",(function(){i.forEach((e=>{e.classList.remove("active"),e.querySelector("i").classList.remove("fa-chevron-up"),e.querySelector("i").classList.add("fa-chevron-down")})),this.classList.add("active"),this.querySelector("i").classList.toggle("fa-chevron-down"),this.querySelector("i").classList.toggle("fa-chevron-up"),s.forEach((e=>e.style.display="none")),document.getElementById(this.dataset.tab).style.display="flex"}))}))})),document.addEventListener("DOMContentLoaded",(()=>{const e=document.querySelectorAll(".industrie-news-card"),t=document.getElementById("loadMoreBtn");let n=3;e.forEach(((e,t)=>{t>=n&&e.classList.add("hidden")})),t.addEventListener("click",(()=>{n+=3,e.forEach(((e,t)=>{t<n&&e.classList.remove("hidden")})),n>=e.length&&t.classList.add("hidden")})),e.length<=n&&t.classList.add("hidden")})),document.addEventListener("DOMContentLoaded",(function(){let e=document.getElementById("marketDataWrapper");const t=document.getElementById("marketSlidePrev"),n=document.getElementById("marketSlideNext"),i=document.getElementById("categoryFilter"),s=document.getElementById("categoryFilterMobile");async function o(t){try{const n=await fetch(`/wp-admin/admin-ajax.php?action=market_ticker&category=${encodeURIComponent(t)}`);if(!n.ok)throw new Error(`HTTP error! Status: ${n.status}`);const i=await n.json();i.success&&i.data&&i.data.html?(e.innerHTML=i.data.html,e=document.getElementById("marketDataWrapper"),r()):e.innerHTML='<p class="error">No data available</p>'}catch(t){e.innerHTML='<p class="error">Failed to load market data</p>'}}function r(){e&&(t?.removeEventListener("click",a),n?.removeEventListener("click",l),t?.addEventListener("click",a),n?.addEventListener("click",l))}function a(){e&&e.scrollBy({left:-300,behavior:"smooth"})}function l(){e&&e.scrollBy({left:300,behavior:"smooth"})}function c(e){o(e.target.value)}i?.addEventListener("change",c),s?.addEventListener("change",c),o(i?.value||"securities"),r()})),document.addEventListener("DOMContentLoaded",(function(){const e=document.getElementById("toggleDropdown"),t=document.querySelectorAll(".future-section__latest-header-catg-item"),n=document.getElementById("latest-news-container");e.addEventListener("click",(()=>{document.querySelector(".future-section__latest-header-catg-list").classList.toggle("active")})),t.forEach((e=>{e.addEventListener("click",(function(){!function(e){const t=new FormData;t.append("action","fetch_latest_posts"),t.append("category_id",e),fetch(ajaxurl,{method:"POST",body:t}).then((e=>e.text())).then((e=>{n.innerHTML=e})).catch((e=>{}))}(this.getAttribute("data-cat"))}))}))})),document.addEventListener("DOMContentLoaded",(function(){const e=document.getElementById("toggleDropdownblog"),t=document.querySelectorAll(".latest-post__featured-section .future-section__latest-header-catg-item"),n=document.getElementById("more-industrie-main"),i=document.querySelector(".pagination");e.addEventListener("click",(()=>{document.querySelector(".latest-post__featured-section .future-section__latest-header-catg-list").classList.toggle("active")})),t.forEach((e=>{e.addEventListener("click",(function(){!function(e){const t=new FormData;t.append("action","fetch_latest_posts_blog"),t.append("category_id",e),fetch(ajaxurl,{method:"POST",body:t}).then((e=>e.json())).then((e=>{n.innerHTML=e.html,e.total_posts<=10?i.style.display="none":i.style.display="flex"})).catch((e=>{}))}(this.getAttribute("data-cat"))}))}))})),e.Alert=T,e.Button=L,e.Carousel=$,e.Collapse=N,e.Dropdown=vt,e.Modal=kt,e.Offcanvas=jt,e.Popover=qt,e.Scrollspy=Wt,e.Tab=Vt,e.Toast=Yt,e.Tooltip=Bt}));
